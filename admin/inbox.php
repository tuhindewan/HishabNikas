...
<?php 
  ...
  if (isset($_GET['message'])) {
     ...
     $del = $Message->deleteMessage($message_id);
  }
	                            ...
	                            <table id="data-table-responsive" class="table table-striped table-bordered">
	                                ...
	                                <tbody>
	                                    ...
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	<?php echo substr($res['message'], 0,50);  ?><?php if (strlen($res['message']) > 50) { ?>.... <?php } ?>
	                                        </td>
	                                        <td class="text-center" style="width:225px !important;">
	                                        	...
	                                        	<a class="btn btn-danger del" href="inbox.php?message=<?php echo $res['id']; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a>
	                                        </td>
	                                    </tr>
	                                    <?php }} ?>
	                                </tbody>
